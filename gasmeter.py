...
def main(argv):
    ...
    if frames:
        ...
        dial1, original_image = gas_classify(camera_path + "0-crop-0.jpg")
        dial2, original_image = gas_classify(camera_path + "0-crop-1.jpg")
        dial3, original_image = gas_classify(camera_path + "0-crop-2.jpg")
        dial4, original_image = gas_classify(camera_path + "0-crop-3.jpg")
    ...
    if (int(rounded) == int(last_reading)):
     ...
     #       os.rename(camera_path + "0-crop-1.jpg", camera_path + "bad/0-crop-1.jpg"+ dt_string)
      ...
      #      os.rename(camera_path + "0-crop-2.jpg", camera_path + "bad/0-crop-2.jpg"+ dt_string)
            print("Recovered  - Ignore First, Second, and Third Digit. Take the last Three digits %s > %s" %
                        (str(last_reading), str(rounded)))
        else:
